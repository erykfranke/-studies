...
<div id = "container">
    <div id = "registrationBox">
        <h1>Zmień zdjęcie</h1>
        <img src="${pageContext.request.contextPath}/${user.photo}" alt="Avatar" width="125px" height="125px" style="border-radius: 50%"/>
        <form action="uploadAvatar" method="post" enctype="multipart/form-data">
            <div style="margin-top: 30px">
                <input type="file" name="file" accept=".jpg, .jpeg, .png">
            </div>
            <div style="margin-top: 40px">
            <input type="submit" value="Upload File" id="createAccount"/>
            </div>
        </form>
    </div>
</div>
