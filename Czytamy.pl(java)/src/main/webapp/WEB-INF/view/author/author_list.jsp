...
<%!
    ...
    private String setFiltersURL(String sortValue, String category, String startLetter)
    {
        if (sortValue == null && startLetter == null){
            return "http://localhost:8080/Czytamy_war_exploded/authors?category="+category;
        } else if (category == null && startLetter == null){
            return "http://localhost:8080/Czytamy_war_exploded/authors?sort="+sortValue;
        } else if (category == null && sortValue == null){
            return "http://localhost:8080/Czytamy_war_exploded/authors?startLetter="+startLetter;
        } else if (sortValue == null){
            return "http://localhost:8080/Czytamy_war_exploded/authors?" +
                    "category="+category+
...
<div id = "container">
    ...
    <div id = "list">
        <div class="beam__">
            ...
            <% if (request.getSession().getAttribute("user") != null) {
                ...
                <div style="float: right; margin-top: -3px">
                    <a href="http://localhost:8080/Czytamy_war_exploded/authors/addAuthor" id="addAuthor">
                        Dodaj autora
                    </a>
                </div>
                <%}%>
        ...
        <c:forEach var="author" items="${list}">
            <div id = "listElement">
                <a href="http://localhost:8080/Czytamy_war_exploded/author/${author.id}">
