...
<div id = "container">
    <div id = "registrationBox">
        <h1>Dodaj nowe wydawcnitwo</h1>
        <form:form method="POST" modelAttribute="author" action="addAuthor" accept-charset="UTF-8">
            <form:hidden path="id" value="${author.id}"/>
            <div class="element">
                <div>Imie: </div>
                <form:input path="name" cssClass="textBox" placeholder = "Wpisz imię autora"/>
            ...
            <div class="element">
                <div>Nazwisko: </div>
                <form:input path="surname" cssClass="textBox" placeholder = "Wpisz nazwsiko autora"/>
            ...
            <div class="element">
                <div>Data ur.: </div>
                <form:input type="date" path="birth_date" cssClass="textBox" placeholder = "Wpisz date urodzenia autora"/>
            </div>

            <div class="element">
                <div>Data ur.: </div>
                <form:textarea type="date" path="description" cssClass="textBox" placeholder = "Opis autora"/>
            </div>

            <div style="margin-top: 80px">
                <input type="submit" placeholder="Utwórz konto" value="addAuthor" id = "select"/>
            </div>
        </form:form>
    </div>
</div>
