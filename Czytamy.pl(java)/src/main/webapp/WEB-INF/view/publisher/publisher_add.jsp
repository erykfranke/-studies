...
<div id = "container">
    <div id = "registrationBox">
        ...
        <form:form method="POST" modelAttribute="publisher" action="addPublisher" accept-charset="UTF-8">
            <form:hidden path="id" value="${publisher.id}"/>
            <div class="element">
                <div>Nazwa wydawnictwa: </div>
                <form:input path="name" cssClass="textBox" placeholder = "Wpisz nazwę wydawnictwa"/>
            ...
            <div class="element">
                ...
                <form:input path="web_site" cssClass="textBox" placeholder = "Wpisz link do strony wydawnictwa"/>
            ...
            <div class="element">
                ...
                <form:textarea path="description" cssClass="textBox" cssStyle="height: 120px" placeholder = "Wpisz informacje o wydawnictwie"/>
            ...
            <div style="margin-top: 80px">
                <input type="submit" placeholder="Utwórz konto" value="addPublisher" id = "select"/>
            </div>
        </form:form>
    </div>
</div>
